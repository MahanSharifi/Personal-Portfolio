export const configuration = {
      ...
      biq: {
        title:'Biquadris',
        date:'August 2021',
        contentA:'-	Fully functional two-player object-oriented Tetris game with no memory leaks, and bonus features.',
        contentB:'-	Implemented a decorator pattern to keep the code clean, easy to manage, and clear.',
        contentC:'-	Designed an MCV UML Diagram to organize project and understand relationships between each class. ',
        contentD:'-	Worked with two group members over several weeks to accomplish the goal. ',
      ...
      biqq: {
        ...
        content: '-	Fully functional two-player object-oriented Tetris game with no memory leaks, and bonus features.',
      ...
      web: {
        ...
        content: '-	A cross-platform fully responsive portfolio created with a great understanding of DOM.',
      },
      led: {
        title: 'Digital Electronic Dice',
        date: 'February 2020',
        tools: 'KiCad',
        content: 'Developed a schematic diagram on KiCad and then soldered in electric pieces to create an LED Dice with sequence designed to begin with output 2 to make the circuit more power efficient.',
      },
      vba: {
        title: 'VBA Math Calculator',
        date: 'September 2020',
        tools: 'VBA, Excel, ActiveX Controls',
        content: '-	Developed multiple mathematical calculator using VBA that helps users identify patterns and relationships in correspondence to their inputted data and function.',
        contentB: '-	Implemented ActiveX controls (COM components) to improve ease of use and user functionality.'
      },
      rock: {
        title: 'Rock Paper Scissors',
        date: 'January 2021',
        tools: 'Java',
        content: 'Rock Paper Scissor game in Java where the user plays with the computer.',
      ...
      coop: {
        ...
        contentA: '-	Experience with all components of SDLC and agile development methodologies - involved in daily SCRUM meetings to keep track of ongoing project statuses.',
        contentB: '-	Developed JSON Parser Validation Tool – wrote, deployed, and tested code.',
        contentC: '-	Fixed bugs on front-end webpage regularly on C# and completed analysis by validating Stored Procedures to front-end C# components to help team for future features/tasks.',
        contentD: '-	Completed integration, and black box testing as well as the daily merge.',
        date: 'Fall 2021'
      },
      youth: {
        title: 'Kitchener Youth Action Council',
        date: 'Co-Chair 2019-2020, Member 2018-2019',
        content: 'Attended weekly meetings diligently and took part in city council planning meetings. I also helped organize the Kitchener Youth awards in 2019. In 2020 (before Covid) my team and I were creating a workshop to help present the risks of nicotine and vaping to students.'
      },
      robot: {
        title: 'First Robotics Club - Team 7722',
        date: 'Programmer 2018-2020',
        content: 'As a member of Resurrection Catholic Secondary Schools FRC Team we won a regional tournament as a rookie team in 2019. I contributed to the drivetrain of the robot in C++ and helped code an autonomous CAN program, involving encoders, and gyro sensors to continuously improve. I also designed an FRC game piece for our team to practice with.'
      },
      deca: {
        title: 'Deca @ Resurrection CSS 2019/2020',
        date: 'School Executive, Regional Winner',
        content: 'Placed 1st @ Deca Regionals in Financial Team Decision Making in 2020.',
        contentB: 'Participated at regionals.',
        contentC: 'As a member and executive I created lesson plans for club members and helped developed critical thinking skills for those around me aswell as my self.'
      },
      football: {
        title: 'Football For The World (FFTW)',
        date: 'Licensed Part Time Coach 2018-2022',
        content: 'Coached kids ranging from age 5-16 in technical and tactial sessions. My mission is to work with boys and girls of different soccer levels and increase their overall soccer IQ and individual performance on the pitch. By demonstraitng excellent proffesionalism, I have always been prepared for each session, organized teams, ran sessions on my own, distrubted apparal, and completed routinely report cards for each player. Not only do I coach soccer techniques, but my goal is teach respect, honesty, collaberation and care to each player as they continue to grow as players and people.'
      },
      vb: {
        title: 'Visual Basics Math Calculator',
        date: 'Janaury 2020',
        contentA: 'Designed a math calculator for reciprocal, radical, and quadratic functions. The buttons were created using activeX controls to complete specific tasks (i.e. clear inputs, calculate inverse/transformation). Mathamtical equations were used on VBA to complete each calculation.',
